...
-- a different country, a country where people speak only the language she was learning. 
--Find out which nearby country speaks nothing but that language.


-- Write SQL query here

-- select countries.name  as countries , countries.code as code
-- from countries
-- join countrylanguages on countries.code = countrylanguages.countrycode
-- where language = 'Italian' and countries.region = 'Southern Europe' limit 1; 
